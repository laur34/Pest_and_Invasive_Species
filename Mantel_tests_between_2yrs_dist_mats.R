# Perform Mantel test between two Jaccard or Bray-Curtis distance matrices of the two years.
# 24.4.2019 LH
...
mantel(d2016_by_trap, d2018_by_trap, method = "pearson", permutations = 999)
